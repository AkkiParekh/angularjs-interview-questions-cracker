...
You can download the PDF and Epub version of this repository from the latest run on the [actions tab](https://github.com/AkkiParekh/angularjs-interview-questions-cracker/actions).
